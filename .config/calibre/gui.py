...
# Main window geometry
main_window_geometry = cPickle.loads('\x80\x02cPyQt5.sip\n_unpickle_type\nq\x01U\x0cPyQt5.QtCoreq\x02U\nQByteArrayUB\x01\xd9\xd0\xcb\x00\x03\x00\x00\x00\x00\x00\x00\x00\x00\x00\x16\x00\x00\x07\x7f\x00\x00\x047\x00\x00\x00\x00\x00\x00\x00\x16\x00\x00\x07\x7f\x00\x00\x047\x00\x00\x00\x00\x00\x00\x00\x00\x07\x80\x00\x00\x00\x00\x00\x00\x00\x16\x00\x00\x07\x7f\x00\x00\x047\x85\x87Rq\x03.')
...
delete_news_from_library_on_upload = True
...
save_to_disk_template_history = cPickle.loads('\x80\x02]q\x01(X)\x00\x00\x00{author_sort}/{title}/{title} - {authors}q\x02X!\x00\x00\x00{author_sort}/{title} - {authors}q\x03e.')
...
viewer_search_history = cPickle.loads('\x80\x02]q\x01(X\x08\x00\x00\x00how veryq\x02X\x12\x00\x00\x00That Painting surpq\x03X\r\x00\x00\x00That Paintingq\x04X\x0c\x00\x00\x00he who despiq\x05X\x0c\x00\x00\x00wedding ringq\x06X\x04\x00\x00\x00otroq\x07X\x04\x00\x00\x00otraq\x08e.')
